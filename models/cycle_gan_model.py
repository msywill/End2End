...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        # 选择需要存储的网络的名字
        # TODO： append segmentor model to be saved on the disk
    ...
    # TODO：set forward for segmentor self.fake_mask = self.net_Seg(self.fakeB)
