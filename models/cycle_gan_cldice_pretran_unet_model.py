...
from monai.transforms import Activations, AsDiscrete, Compose, ScaleIntensity



class CycleGANCldicePreTranUnetModel(BaseModel):
    """
...
#         if self.opt.train_phase == 2 or self.opt.train_phase == 4:
        ...
        self.pre_trans = ScaleIntensity(minv=0, maxv=1)
    ...
    def forward_gan_unet(self):
        ...
        self.fake_low = self.u_net(self.pre_trans(self.fake_B))
    ...
    def forward_unet(self):
        ...
        self.fake_mask = self.u_net(self.pre_trans(fake_B_u))  # 不影响GA的参数
